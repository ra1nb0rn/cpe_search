...
class TestSearches(unittest.TestCase):
    ...
    def test_apache_airflow_no_version(self):
        ...
        query = "Airflow"
        result = search_cpes(query)["pot_cpes"]
        expected_related_cpes = [("cpe:2.3:a:apache:airflow:*:*:*:*:*:*:*:*", 0.6782957433483083)]
        for i, (expected_related_cpe, match_score) in enumerate(expected_related_cpes):
            self.assertEqual(expected_related_cpe, result[i][0])
            self.assertAlmostEqual(match_score, result[i][1])
    ...
    def test_search_dell_omsa_9_4_0_2(self):
        ...
        result = search_cpes(query)["pot_cpes"]
        expected_related_cpes = [
            ("cpe:2.3:a:dell:openmanage_server_administrator:9.4.0.2:*:*:*:*:*:*:*", -0.9547229134924251),
            ("cpe:2.3:a:dell:openmanage_server_administrator:*:*:*:*:*:*:*:*", 0.9547229134924251),
            ("cpe:2.3:a:dell:openmanage_server_administrator:5.2.0:*:*:*:*:*:*:*", 0.9356286465015572),
            ("cpe:2.3:a:dell:emc_openmanage_server_administrator:9.4.0.2:*:*:*:*:*:*:*", -0.842635458433608),
            ("cpe:2.3:a:dell:emc_openmanage_server_administrator:*:*:*:*:*:*:*:*", 0.842635458433608),
            (
    ...
    def test_search_citrix_adc_13_1_42_47(self):
        ...
        result = search_cpes(query)["pot_cpes"]
        expected_related_cpes = [
            ('cpe:2.3:a:citrix:application_delivery_controller:13.1:42.47:*:*:-:*:*:*', -0.9443356111798747),
            ('cpe:2.3:a:citrix:application_delivery_controller:13.1-42.47:*:*:*:-:*:*:*', -0.9443356111798747),
            ('cpe:2.3:a:citrix:application_delivery_controller:13.1:*:*:*:-:*:*:*', 0.9443356111798747),
            ('cpe:2.3:a:citrix:application_delivery_controller:*:*:*:*:*:*:*:*', 0.9383570285533676),
            ('cpe:2.3:h:citrix:application_delivery_controller:13.1:*:*:*:*:*:*:*', -0.9195900759823716),
            ('cpe:2.3:h:citrix:application_delivery_controller:13.1:42.47:*:*:*:*:*:*', -0.9195900759823716),
            ('cpe:2.3:h:citrix:application_delivery_controller:13.1-42.47:*:*:*:*:*:*:*', -0.9195900759823716)
        ]
        for i, (expected_related_cpe, match_score) in enumerate(expected_related_cpes):
            self.assertEqual(expected_related_cpe, result[i][0])
    ...
    def test_search_citrix_adc_no_version(self):
        ...
        result = search_cpes(query)["pot_cpes"]
        expected_related_cpes = [
            ('cpe:2.3:a:citrix:application_delivery_controller:*:*:*:*:*:*:*:*', 0.9836819689304376),
            ('cpe:2.3:h:citrix:application_delivery_controller:-:*:*:*:*:*:*:*', 0.9640085266327638),
            ('cpe:2.3:a:citrix:application_delivery_controller:*:*:*:*:fips:*:*:*', 0.9113912926238704),
            ('cpe:2.3:o:citrix:application_delivery_controller_firmware:*:*:*:*:*:*:*:*', 0.9113912926238704),
            ('cpe:2.3:a:citrix:netscaler_application_delivery_controller:*:*:*:*:*:*:*:*', 0.8681946302204777),
            ('cpe:2.3:o:citrix:application_delivery_controller_firmware:*:*:*:*:fips:*:*:*', 0.8609356974951642)
        ]
        for i, (expected_related_cpe, match_score) in enumerate(expected_related_cpes):
            self.assertEqual(expected_related_cpe, result[i][0])
            self.assertAlmostEqual(match_score, result[i][1])
    ...
    def test_search_datatables_1_9_4(self):
        ...
        result = search_cpes(query)["pot_cpes"]
        expected_related_cpes = [
            ('cpe:2.3:a:datatables:datatables.net:1.9.4:*:*:*:*:node.js:*:*', -0.49134820156011955),
            ...
            ('cpe:2.3:a:datatables:datatables.net:1.10.0:-:*:*:*:node.js:*:*', 0.43397267978578885),
            ('cpe:2.3:a:datatables:datatables.net:1.9.4:beta1:*:*:*:node.js:*:*', -0.41674310186320396),
            ('cpe:2.3:a:datatables:datatables.net:1.10.0:beta1:*:*:*:node.js:*:*', 0.41674310186320396),
    ...
    def test_search_microsoft_sql_server_2019_15_00_2000_00_RTM(self):
        ...
        expected_related_cpes = [
            ...
            ('cpe:2.3:a:microsoft:sql_server_2019:2019:15.00.2000.00:*:*:*:*:*:*', -0.7523479560247004),
            ('cpe:2.3:a:microsoft:sql_server_2019:2019:15.00.2000.00:RTM:*:*:*:*:*', -0.7523479560247004),
            ('cpe:2.3:a:microsoft:sql_server_2019:2019_15.00.2000.00_RTM:*:*:*:*:*:*:*', -0.7523479560247004),
            ('cpe:2.3:a:microsoft:sql_server_2019:*:*:*:*:*:*:*:*', 0.7523479560247004),
            ('cpe:2.3:a:microsoft:sql_server:2019:15.00.2000.00:*:*:*:*:*:*', -0.735100474327692),
            ('cpe:2.3:a:microsoft:sql_server:2019:15.00.2000.00:RTM:*:*:*:*:*', -0.735100474327692),
            ('cpe:2.3:a:microsoft:sql_server:2019_15.00.2000.00_RTM:*:*:*:*:*:*:*', -0.735100474327692),
            ('cpe:2.3:a:microsoft:sql_server:2019:*:*:*:*:*:*:*', 0.735100474327692),
            ('cpe:2.3:a:microsoft:sql_server_2019:2019:*:*:*:*:*:x64:*', -0.6970579900837518),
            ('cpe:2.3:a:microsoft:sql_server_2019:2019:15.00.2000.00:*:*:*:*:x64:*', -0.6970579900837518),
            ('cpe:2.3:a:microsoft:sql_server_2019:2019:15.00.2000.00:RTM:*:*:*:x64:*', -0.6970579900837518),
            ('cpe:2.3:a:microsoft:sql_server_2019:2019_15.00.2000.00_RTM:*:*:*:*:*:x64:*', -0.6970579900837518),
